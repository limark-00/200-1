...
修改 `config.py` 中的 `APP_PORT`，或 `lsof -i :5001` 查看占用进程。
</details>
...
- 外接摄像头需修改 `camera.py` 的 `camera_index` 参数
</details>
...
- [实训技术文档.md](./smart-home-console/实训技术文档.md) — 面向小白的完整原理与代码修改指南
- [巴法云文档](https://cloud.bemfa.com/docs/) — IoT 平台官方文档
- [FastAPI 中文文档](https://fastapi.tiangolo.com/zh/) — 框架官方中文教程
